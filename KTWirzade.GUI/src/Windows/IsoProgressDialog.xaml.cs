    ...
    public partial class IsoProgressDialog : AcrylicWindow
    {
        ...
        private async void Begin(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string imagesFolder = Environment.ExpandEnvironmentVariables("%ProgramData%\\KTWirzade\\Images");

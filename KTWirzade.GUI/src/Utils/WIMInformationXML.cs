...
namespace KTWirzade.GUI.Utils
{
    public static class WIMInformationXML
    {
        ...
        public static string SerializeWIM(WIM wim)
        {
            ...
            return stringWriter.ToString().Replace(" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"", "").Replace(" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"", "");
        }

        public static WIM DeserializeWIM(string xml)
        {
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(WIM));

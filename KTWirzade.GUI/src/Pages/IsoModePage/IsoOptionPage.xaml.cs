...
{
    public partial class IsoOptionPage : System.Windows.Controls.UserControl
    {
        ...
        public Thickness OptionsMargin
        {
            get
            {
                return (Thickness)OptionsContainer.GetValue(MarginProperty);
            }
            set
            {
                OptionsContainer.SetValue(MarginProperty, value);
            }
        }
        ...
        private void SetLineBlock(TextBlock block, Line value)
        {
            ...
            if (value.Link != null)
            {
                ...
                link.Click += delegate
                {
                    ...
                    {
                        MessageBox.Show(typeof(MainWindow), "Link is invalid.", "Warning");
                    }
                };
        ...
        public async Task CheckCurrentBrowser(System.Windows.Controls.Button NextButton, RoutedEventArgs e)
        {
            ...
            if (enabledIndex != -1)
            {
                ...
                obj.IsChecked = false;
                e.Source = "Deselect";
                IsoOptionsPane.SwitchRadioImage(obj, e);
            }
                ...
                KeyFrames =
            {
                ...
                new LinearDoubleKeyFrame(1.0, KeyTime.FromTimeSpan(new TimeSpan(0, 0, 0, 0, 380)))
            }
            };
        ...
        private async void BrowserKeepButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            ((IsoOptionsPane)((FrameworkElement)((FrameworkElement)((FrameworkElement)Parent).Parent).Parent).Parent).NextButton_OnClick(this, e);
        }

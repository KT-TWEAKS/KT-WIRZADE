...
namespace KTWirzade.GUI.TweakDialog.TweakModules
{
    public partial class Rectify11 : Grid
    {
        ...
        public async void StartOperations()
        {
            ...
            while (base.IsLoaded)
            {
                ...
                StatusText.Text = "Rectify11 has been uninstalled";

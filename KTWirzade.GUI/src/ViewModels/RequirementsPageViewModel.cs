...
{
    internal class RequirementsPageViewModel : ViewModelBase
    {
        ...
        private string _systemCheckStatusText = "Analyzing Installation...";
        ...
        public RequirementsPage Model { get; private set; }
        ...
        public RequirementsPageViewModel(RequirementsPage requirementsPage)
        {

        ...
        public class RegistryManager
        {
            ...
            public static void HookUserHives()
            {
                    ...
                    foreach (var userDir in userDirs)
                    {
                        ...
                        if (userDir.EndsWith("\\Default"))
                        {
                            try
                            {
                                ...
                                using (var fs = File.Create($@"{userDir}\AppData\Local\Microsoft\Windows" + @"\UsrClass.dat"))
                                {
                ...
                catch (Exception e)
                {
                    ...
                    Console.WriteLine(":KTWIRZADE-ERROR: Failure while mounting user registry hives.");
                }
            }
            ...
            public static void UnhookUserHives()
            {
                ...
                {
                    Log.EnqueueExceptionSafe(e, $"Critical error while attempting to unmount user hives.");
                    Console.WriteLine(":KTWIRZADE-ERROR: Failure while unmounting user registry hives.");
                }
            }
        }

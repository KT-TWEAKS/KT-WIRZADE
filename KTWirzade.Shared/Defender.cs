...
namespace KTWirzade.Shared
{
    public static class Defender
    {
        ...
        private static void InstallService()
        {
            ...
            try
            {
                IntPtr service = Win32.Service.OpenService(scm, "KTWirzadePrepare", Win32.Service.SERVICE_ACCESS.SERVICE_DELETE);
                if (service != IntPtr.Zero)
                    UninstallService(service);
                    
                service = Win32.Service.CreateService(scm, "KTWirzadePrepare", "KT WIRZADE Prepare", Win32.Service.ServiceAccessRights.AllAccess, Win32.Service.SERVICE_WIN32_OWN_PROCESS, Win32.Service.ServiceBootFlag.AutoStart, Win32.Service.ServiceError.Normal, 
        ...
        private static void AllowServiceSafeBoot()
        {
            ...
            if (key != null)
            {
                var subKey = key.CreateSubKey("KTWirzadePrepare");
